    ...
    <div className="max-w-[1000px] mx-auto pb-20">
      <div className="flex flex-wrap items-end justify-between gap-4 mb-8">
        ...
        <div className="flex gap-3">
           <button className="flex items-center justify-center px-6 h-9 rounded-lg bg-blue-600 text-white text-sm font-medium hover:bg-blue-500 transition-colors shadow-sm focus:ring-2 focus:ring-blue-500/40 focus:ring-offset-1 dark:focus:ring-offset-slate-900">
            Save Configuration
          </button>
        </div>
      </div>
            ...
            <div className="p-6 md:p-8 space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl">
                    ...
                    <div className="relative">
                        ...
                        <input className="w-full rounded-md border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 text-slate-900 dark:text-white placeholder:text-slate-400 text-sm h-10 pl-7 pr-4 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm" id="credit-limit" placeholder="0.00" type="number" defaultValue="5000.00"/>
                    </div>
                    </div>
                    <div className="flex flex-col gap-2">
